...
GraphicsPipelineManager::GraphicsPipelineManager()
	: _pipelineLayout(nullptr), _graphicsPipeline(nullptr)
{
...
void GraphicsPipelineManager::createGraphicsPipeline(VkDevice device, VkPhysicalDevice physicalDevice, 
...
void GraphicsPipelineManager::destroyGraphicsPipelineAndLayout(VkDevice device)
{
...
void GraphicsPipelineManager::destroyDescriptorSetLayout(VkDevice device)
{
