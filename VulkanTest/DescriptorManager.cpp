...
void DescriptorManager::createDescriptorSets(VkDevice device, std::vector<VkBuffer>&& uniformBuffers, TextureManager& textureManager)
{
	...
	for (size_t i = 0; i < MAX_FRAMES_IN_FLIGHT; i++) {
		...
		imageInfo.imageView = textureManager.textureImageView;
...
void DescriptorManager::destroyDescriptorSetLayout(VkDevice device)
{
